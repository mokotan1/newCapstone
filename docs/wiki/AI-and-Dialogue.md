...
- Production stack routes Unity chat UI through FastAPI `/chat` endpoints to a local LiteRT Gemma runtime (`AI_PROVIDER=local`), with no Groq or Gemini execution path. ([source_id: technical:ded8fb508f0d](sources/technical/architecture--ded8fb508f0d.md))
