...
- Production stack routes Unity chat UI through FastAPI `/chat` endpoints with Groq primary and Gemini fallback providers. ([source_id: technical:505bbb50868b](sources/technical/architecture--505bbb50868b.md))
