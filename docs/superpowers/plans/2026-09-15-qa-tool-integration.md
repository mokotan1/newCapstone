...
- [x] Task 8b: isolation / diffHash / console / defect (AC05, AC16, AC11, AC20) — pytest + live coverage
- [x] Task 9: live Unity run (AC19) — Play Mode 실호출 FAIL, Kitchen 미도착, stub 아님
