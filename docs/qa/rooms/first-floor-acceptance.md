...
| kitchen | IMPLEMENTED | full pack | PlayMode bottle→faucet→key→exit.assert PASS (`FaucetClicked` via QA Say completion; MaidRoomKey spawn + pickup). EditMode Kitchen* DeveloperQa green. No force-solve PASS |
